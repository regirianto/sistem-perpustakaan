...
$books =query("SELECT * FROM tbbuku");
if(isset($_POST['cari'])){
...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0"  action="" method="POST" >
      <input class="form-control mr-sm-2 keyword" type="search" placeholder="Search" aria-label="Search" name="pencarian" autocomplete="off">
